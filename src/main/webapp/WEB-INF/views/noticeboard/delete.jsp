...
<div class="container"  style="margin-top:5%; min-height:500px">
		<h3>NOTICE BOARD</h3>
		<form action="${pageContext.request.contextPath}/noticeboard/delete?bno=${param.bno}" method="post"   id="deleteForm"> 
			<div class="form-group">
			  <label for="bpass"  >비밀번호</label>
			  <input type="password"   name="bpass"   id="bpass"   class="form-control" > 
			  <input type="hidden"   name="bno"   id="bno" value="${param.bno}" class="form-control" >
			  <span>(*) 삭제시 필수입니다. </span>
			</div>
			<div class="form-group">
